...
export class DateHelper {
   ...
   * @see https://momentjs.com/docs/#/parsing/string-format/
   */
  static SQL_DATE_FORMAT: IMomentFormat = "YYYY-MM-DD";
   ...
   */
  static SQL_DATE_TIME_FORMAT: IMomentFormat = "YYYY-MM-DD HH:mm:ss";
   ...
   * @see https://momentjs.com/docs/#/parsing/string-format/
   */
  static SQL_TIME_FORMAT: IMomentFormat = "HH:mm:ss";
  ...
  */
  static addMonths(months: number, date?: Date, format?: IMomentFormat): Date {
  ...
  */
   ...
   * ```
   */
  static formatDate(date?: Date, format?: IMomentFormat): string {
    try {
      const parsedDate = moment(date);
      if (parsedDate.isValid()) {
        return parsedDate.format((defaultStr(format, DateHelper.DEFAULT_DATE_TIME_FORMAT) as unknown) as IMomentFormat);
      }
    } catch (error) { }
