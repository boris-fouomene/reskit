...
module.exports = {
	...
	NG: function NG(props) {
		return (
			<Svg
				...
				{...props}
			>
				<Path d="M0 85.331H512V426.668H0z" fill="#f0f0f0" />
				<Path d="M0 85.331H170.663V426.668H0z" fill="#6da544" />
				<Path d="M341.337 85.331H512V426.668H341.337z" fill="#6da544" />
			</Svg>
		)
	},
	IT: function IT(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
			...
			>
				<Path
					d="M341.334 85.33L170.666 85.33 0 85.33 0 426.662 170.666 426.662 341.334 426.662 512 426.662 512 85.33z"
					fill="#f0f0f0"
				/>
				<Path d="M0 85.333H170.663V426.66999999999996H0z" fill="#6da544" />
				<Path
					d="M341.337 85.333H512V426.66999999999996H341.337z"
					fill="#d80027"
				/>
			</Svg>
		)
	},
	MT: function MT(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
				...
				{...props}
			>
				<Path d="M0 85.331H512V426.65700000000004H0z" fill="#f0f0f0" />
				<Path d="M256 85.331H512V426.668H256z" fill="#d80027" />
				<Path
					d="M208.231 138.671L208.231 117.337 186.899 117.337 186.899 138.671 165.565 138.671 165.565 160.003 186.899 160.003 186.899 181.337 208.231 181.337 208.231 160.003 229.565 160.003 229.565 138.671z"
					fill="#acabb1"
				/>
			</Svg>
		)
	},
	TN: function TN(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
			...
			>
				<Path d="M0 85.331H512V426.668H0z" fill="#d80027" />
				<Circle cx={256} cy={255.994} r={96} fill="#f0f0f0" />
				<Path
					d="M267.826 219.291L284.296 241.986 310.969 233.337 294.473 256.013 310.941 278.708 284.277 270.027 267.782 292.703 267.799 264.663 241.135 255.981 267.809 247.333z"
					fill="#d80027"
				/>
				<Path
	...
	NI: function NI(props) {
		return (
			...
			>
				<Path d="M0 85.337H512V426.663H0z" fill="#f0f0f0" />
				<Path d="M0 85.337H512V199.11200000000002H0z" fill="#338af3" />
				<Path d="M0 312.888H512V426.663H0z" fill="#338af3" />
				<Path
				...
				/>
				<Path
					d="M276.563 261.936L256 256 235.437 261.936 228.582 273.809 283.418 273.809z"
					fill="#0052b4"
				/>
				<Path
					d="M256 226.32L242.291 250.064 256 256 269.709 250.064z"
					fill="#338af3"
				/>
				<Path
					d="M235.437 261.936L276.563 261.936 269.709 250.064 242.291 250.064z"
					fill="#6da544"
				/>
			</Svg>
		)
	},
	ZM: function ZMFlag(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
				...
				{...props}
			>
				<Path d="M0 85.331H512V426.668H0z" fill="#496e2d" />
				<Path
				...
				/>
				<Path
					d="M341.337 255.994H398.22499999999997V426.65700000000004H341.337z"
					fill="#d80027"
				/>
				<Path
					d="M455.112 255.994H512V426.65700000000004H455.112z"
					fill="#ff9811"
				/>
				<Path d="M398.225 255.994H455.113V426.65700000000004H398.225z" />
			</Svg>
		)
	},
	QA: function QAFlag(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
				...
				{...props}
			>
				<Path d="M2.216 86.076H512V425.924H2.216z" fill="#751a46" />
				<Path
					d="M209.455 154.969L159.219 180.236 209.455 205.493 159.219 230.76 209.455 256.017 159.219 281.283 209.455 306.54 159.219 331.808 209.455 357.065 159.219 382.332 209.455 407.6 173.005 425.93 0 425.93 0 86.07 172.939 86.07 209.455 104.434 159.219 129.701z"
					fill="#f0f0f0"
				/>
			</Svg>
		)
	},
	NA: function NAFlag(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
				...
				{...props}
			>
				<Path d="M0 85.337H512V426.663H0z" fill="#496e2d" />
				<Path d="M0 426.663L0 85.337 512 85.337" fill="#0052b4" />
				<Path
					d="M512 152.222L512 85.337 411.67 85.337 0 359.778 0 426.663 100.33 426.663z"
					fill="#f0f0f0"
				/>
				<Path
					d="M512 85.337L512 125.462 60.193 426.663 0 426.663 0 386.538 451.807 85.337z"
					fill="#a2001d"
				/>
				<Path
	...
	MU: function MUFlag(props) {
		return (
			<Svg
				...
				{...props}
			>
				<Path d="M0 85.331H512V426.65700000000004H0z" fill="#ffda44" />
				<Path d="M0 85.331H512V170.668H0z" fill="#d80027" />
				<Path d="M0 170.657H512V255.99400000000003H0z" fill="#0052b4" />
				<Path d="M0 341.331H512V426.668H0z" fill="#6da544" />
			</Svg>
		)
	},
	LU: function LUFlag(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
	...
	LT: function LTFlag(props) {
		return (
			<Svg
				...
				{...props}
			>
				<Path d="M0 85.337H512V426.663H0z" fill="#6da544" />
				<Path d="M0 85.337H512V199.11200000000002H0z" fill="#ffda44" />
				<Path d="M0 312.888H512V426.663H0z" fill="#d80027" />
			</Svg>
		)
	},
	JM: function JMFlag(props) {
		return (
			<Svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
			...
			>
				<Path d="M0 85.337H512V426.663H0z" fill="#6da544" />
				<Path d="M215.864 256.006L0 399.911 0 112.089z" />
				<Path d="M512 112.089L512 399.911 296.136 256.006z" />
				<Path
					d="M512 112.089L296.136 256.006 512 399.911 512 426.668 471.875 426.668 256 282.752 40.125 426.668 0 426.668 0 399.911 215.864 256.006 0 112.089 0 85.331 40.125 85.331 256 229.248 471.875 85.331 512 85.331z"
					fill="#0052b4"
				/>
				<Path
					d="M512 112.089L296.136 256.006 512 399.911 512 426.668 471.875 426.668 256 282.752 40.125 426.668 0 426.668 0 399.911 215.864 256.006 0 112.089 0 85.331 40.125 85.331 256 229.248 471.875 85.331 512 85.331z"
	...
	HN: function HNFlag(props) {
		return (
			...
			>
				...
				<Path d="M0 312.888H512V426.663H0z" fill="#338af3" />
				<Path
					d="M203.491 208.511L207.912 222.116 222.217 222.116 210.643 230.524 215.064 244.128 203.491 235.72 191.919 244.128 196.34 230.524 184.766 222.116 199.071 222.116z"
					fill="#338af3"
				/>
				<Path
					d="M203.491 267.872L207.912 281.478 222.217 281.478 210.643 289.884 215.064 303.489 203.491 295.081 191.919 303.489 196.34 289.884 184.766 281.478 199.071 281.478z"
					fill="#338af3"
				/>
				<Path
					d="M308.509 208.511L312.929 222.116 327.234 222.116 315.66 230.524 320.081 244.128 308.509 235.72 296.936 244.128 301.357 230.524 289.783 222.116 304.088 222.116z"
					fill="#338af3"
				/>
				<Path
					d="M308.509 267.872L312.929 281.478 327.234 281.478 315.66 289.884 320.081 303.489 308.509 295.081 296.936 303.489 301.357 289.884 289.783 281.478 304.088 281.478z"
					fill="#338af3"
				/>
				<Path
					d="M256 238.191L260.421 251.796 274.725 251.796 263.152 260.204 267.573 273.809 256 265.401 244.427 273.809 248.848 260.204 237.275 251.796 251.579 251.796z"
					fill="#338af3"
				/>
			</Svg>
		)
