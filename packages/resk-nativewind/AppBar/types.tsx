 ...
 * };
 */
export type IAppBarProps<IAppBarActionContext = unknown> = ISurfaceProps & {
 ...
 * };
 */
export type IAppBarAction<IAppBarActionContext = unknown> = IMenuItemBase<IAppBarContext<IAppBarActionContext>>;
 ...
 * };
 */
export type IAppBarContext<IAppBarActionContext = unknown> = IAppBarActionContext & {
    isAppBar: boolean;
    textColor: string;
    backgroundColor: string;
};