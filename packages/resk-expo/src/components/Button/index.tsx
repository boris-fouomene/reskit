...
import { IButtonMode, IButtonProps, IButtonRef } from './types';
 ...
 * </Button>
 */
export const Button = forwardRef<any, IButtonProps<any>>(function Button<T extends object = any>(
    {
    ...
    ref: React.ForwardedRef<IButtonRef<Partial<T>>>
) {
    ...
    React.useImperativeHandle(ref, () => ({
        ...context,
        ...Object.assign({}, typeof extendRef == "function" ? extendRef(context) : {}),
        get ref() {
            return innerRef.current;
        }
    } as IButtonRef<Partial<T>>));
    ...
    const icon = useGetIcon<T>({ ...(rest as T), icon: iconProp, size: iconSize, ...iconProps, color: iconColor as unknown as string, theme });
