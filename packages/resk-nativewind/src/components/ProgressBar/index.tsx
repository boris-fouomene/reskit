...
export function ProgressBar({
    ...
    return <Div title={title} accessibilityRole="progressbar"
        ...
        aria-valuenow={value}
        role="progressbar"
        {...props} className={cn("w-full progress-bar relative", indeterminate && "progressbar-indeterminate", computedVariant.base(), className)}
        testID={testID}
    >
        <Div
            aria-valuenow={value}
        ...
        >
            <Div
                role="presentation"
                testID={testID + "-fill"}
                className={cn(indeterminate && cn("w-full h-full", isRTL ? "progress-bar-indeterminate-rtl" : "progress-bar-indeterminate"), fillClassName)}
