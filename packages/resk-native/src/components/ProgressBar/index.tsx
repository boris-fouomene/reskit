...
export type IProgressBarProps = React.ComponentPropsWithRef<typeof View> & {
    ...
    progress?: number;
    /**
     * Scale factor for the progress bar animation.
     */
...
const ProgressBar = ({
    ...
    const passedAnimatedValue =
        React.useRef<IProgressBarProps['animatedValue']>(animatedValue);
    ...
    animationScale = typeof animationScale == 'number' && animationScale > 0 ? animationScale : 1.0;
    ...
    }, [fade, animationScale, indeterminate, timer, progress, isWeb]);
