"use client";
import "./types";
import { cn, getTextContent, ObservableComponent } from "@utils/index";
import { IFieldType, IField, } from "@resk/core/resources";
...
import { IFormData, IFormEvent } from "./types";
...
export class Field<Type extends IFieldType = IFieldType, ValueType = any> extends ObservableComponent<IField<Type>, IFormFieldState<Type, ValueType>, IFormEvent> {
    ...
    */
    ...
    canValidateOnBlur(): boolean {
        return this.props.validateOnBlur !== false && this.props.validateOnBlur !== false;
    }
    /**
