export const validator = {
  ...
  arrayOf: "The field %{fieldName} must be an array where each item matches all the specified rules. Errors:\n%{failedRulesErrors}",
  oneOf: "The field %{fieldName} must match at least one of the following validation rules:\n%{failedRulesErrors}",
  allOf: "The field %{fieldName} must match all of the following validation rules:\n%{failedRulesErrors}",
  validateNested: "The field %{fieldName} must be a valid nested object. Errors:\n%{nestedErrors}",
  validateNestedInvalidType: "The field %{fieldName} must be an object, but received %{receivedType}",
